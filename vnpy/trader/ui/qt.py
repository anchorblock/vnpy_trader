...
class ExceptionWidget(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        """"""
        self.setWindowTitle("trigger exception")
        ...
        community_button: QtWidgets.QPushButton = QtWidgets.QPushButton("ask for help")
        community_button.clicked.connect(self._open_community)

        close_button: QtWidgets.QPushButton = QtWidgets.QPushButton("closure")
