...
class TickMonitor(BaseMonitor):
    ...
    headers: dict = {
        ...
        "low_price": {"display": "lowest price", "cell": BaseCell, "update": True},
        ...
        "gateway_name": {"display": "gateway_name", "cell": BaseCell, "update": False},
    }
...
class QuoteMonitor(BaseMonitor):
    ...
    def init_ui(self):
        ...
        self.setToolTip("Double-click a cell to undo a quote")
...
class TradingWidget(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.price_check.setToolTip("Set the price to update with the market")

        send_button: QtWidgets.QPushButton = QtWidgets.QPushButton("entrust")
        send_button.clicked.connect(self.send_order)

        cancel_button: QtWidgets.QPushButton = QtWidgets.QPushButton("Withdraw all")
        cancel_button.clicked.connect(self.cancel_all)

        grid: QtWidgets.QGridLayout = QtWidgets.QGridLayout()
        grid.addWidget(QtWidgets.QLabel("exchange"), 0, 0)
        grid.addWidget(QtWidgets.QLabel("the code"), 1, 0)
        grid.addWidget(QtWidgets.QLabel("name"), 2, 0)
        grid.addWidget(QtWidgets.QLabel("direction"), 3, 0)
        grid.addWidget(QtWidgets.QLabel("Kaiping"), 4, 0)
        grid.addWidget(QtWidgets.QLabel("type"), 5, 0)
        grid.addWidget(QtWidgets.QLabel("price"), 6, 0)
        grid.addWidget(QtWidgets.QLabel("quantity"), 7, 0)
        grid.addWidget(QtWidgets.QLabel("interface"), 8, 0)
    ...
    def send_order(self) -> None:
        ...
        symbol: str = str(self.symbol_line.text())
        if not symbol:
            QtWidgets.QMessageBox.critical(self, "commission failed", "Please enter the contract code")
            return

        volume_text: str = str(self.volume_line.text())
        if not volume_text:
            QtWidgets.QMessageBox.critical(self, "commission failed", "Please enter the order quantity")
            return
...
class ContractManager(QtWidgets.QWidget):
    ...
    def init_ui(self) -> None:
        ...
        self.filter_line.setPlaceholderText("Enter the contract code or exchange, leave blank to query all contracts")

        self.button_show: QtWidgets.QPushButton = QtWidgets.QPushButton("Inquire")
...
class GlobalDialog(QtWidgets.QDialog):
    ...
    def init_ui(self) -> None:
        ...
        button: QtWidgets.QPushButton = QtWidgets.QPushButton("Sure")
    ...
    def update_setting(self) -> None:
        ...
        QtWidgets.QMessageBox.information(
            self,
            "Notice",
            "The modification of the global configuration will take effect only after restarting!",
